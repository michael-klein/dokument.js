      ...
      <div class="flex flex-col sm:flex-row sm:justify-around">
        <div class="w-72 h-screen">
          ...
          <nav class="mt-10 px-6 ">
            ...
            <a
              class="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200 border-r-2 border-gray-600 dark:border-gray-300 text-gray-800 dark:text-gray-100  bg-gray-100 dark:bg-gray-600"
              href="#"
            >
              <svg
                width="20"
